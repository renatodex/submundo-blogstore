    ...
    class redux_theme_Redux_Framework_config {
        ...
        public function setSections() {
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    array(
                        ...
                        'type' => 'select',
                        'options' => array(
                            'full-width' => __( 'Full Width Layout', 'commercegurus' ),
                            'boxed' => __( 'Boxed Layout', 'commercegurus' ),
                        ),
                    ...
                    array(
                        ...
                        'type' => 'select',
                        'options' => array(
                            'enabled' => __( 'Enabled', 'commercegurus' ),
                            'disabled' => __( 'Disabled', 'commercegurus' ),
                        ),
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    array(
                        ...
                        'type' => 'select',
                        'options' => array(
                            'none' => __( 'No skin - use custom', 'commercegurus' ),
                            '#d54800' => __( 'Red', 'commercegurus' ),
                            '#1e73be' => __( 'Blue', 'commercegurus' ),
                            '#519d42' => __( 'Green', 'commercegurus' ),
                            '#9b3b85' => __( 'Purple', 'commercegurus' ),
                        ),
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'id' => 'cg_favicon',
                        'type' => 'media',
                        'title' => __( 'Favicon', 'commercegurus' ),
                        'url' => true,
                    ),
                    array(
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    array(
                        'desc' => __( 'Select where you would like to position your logo and menu', 'commercegurus' ),
                        'id' => 'cg_logo_position',
                        'type' => 'select',
                        'title' => __( 'Header Logo Position', 'commercegurus' ),
                        'options' => array(
                            'left' => __( 'Left Logo with Left Menu', 'commercegurus' ),
                            'center' => __( 'Center Logo with Left Menu', 'commercegurus' ),
                            'center-logo-center-menu' => __( 'Center Logo with Center Menu', 'commercegurus' ),
                        ),
                        'default' => 'center-logo-center-menu',
                    ),                    
                    array(
                        ...
                        'max' => '500',
                        'type' => 'slider',
                        'title' => __( 'Header height', 'commercegurus' ),
                        'default' => '110',
                    ),
                    array(
                    ...
                    array(
                        'desc' => __( 'Enable or disable shop announcements in your header. (Note: Announcements are not shown on the Center Menu - Center Logo header layout.', 'commercegurus' ),
                    ...
                    array(
                        ...
                        'options' => array(
                            'cart' => __( 'Cart', 'commercegurus' ),
                            'basket' => __( 'Basket', 'commercegurus' ),
                            'bag' => __( 'Bag', 'commercegurus' ),
                        ),
                        'default' => 'basket',
                    ),
                ),
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        //'preview'       => false, // Disable the previewer
                        'all_styles' => true, // Enable all Google Font style/weight variations to be added to the page
                        'output' => array( '.cg-header-fixed .menu > li.menu-full-width .cg-submenu-ddown .container > ul > li > a, .cg-primary-menu .menu > li.menu-full-width .cg-submenu-ddown .container > ul > li > a, .menu-full-width .cg-menu-title, .cg-header-fixed .menu > li.menu-full-width .cg-submenu-ddown .container > ul .menu-item-has-children > a,
.cg-primary-menu .menu > li.menu-full-width .cg-submenu-ddown .container > ul .menu-item-has-children > a' ), // An array of CSS selectors to apply this font style to dynamically
                        'units' => 'px', // Defaults to px
                        'subtitle' => __( 'Typography option with each property can be called individually.', 'commercegurus' ),
                        'default' => array(
                            'color' => '#111',
                    ...
                    array(
                        'desc' => __( 'Do you want to display the sticky menu? A sticky menu is a menu which fixes itself to the top of your screen as your scroll further down the page.', 'commercegurus' ),
                        'id' => 'cg_sticky_menu',
                        'type' => 'select',
                        'options' => array(
                            'yes' => __( 'Yes', 'commercegurus' ),
                        ...
                        'title' => __( 'Display sticky menu?', 'commercegurus' ),
                        'default' => 'yes',
                    ),
                    array(
                ...
                if ( $cg_primary_menuitems ) {
                    foreach ( $cg_primary_menuitems as $item ) {
                        if ( $item->menu_item_parent === '0' ) {
                            ...
                            $cg_menu_fields[] = array(
                                'desc' => __( 'Upload your menu image', 'commercegurus' ),
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    array(
                        ...
                        'type' => 'text',
                        'title' => __( 'Footer text', 'commercegurus' ),
                        'default' => __( '<p>&copy; 2015 CommerceGurus</p>', 'commercegurus' ),
                    ),
                    array(
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    array(
                        ...
                        'type' => 'text',
                        'title' => __( 'Blog Page Title', 'commercegurus' ),
                        'default' => __( 'Blog', 'commercegurus' ),
                    ),
                    array(
                        'desc' => __( 'Upload an optional background image for your blog archives page title. The image should be at least 1200px wide for best results.', 'commercegurus' ),
                        'id' => 'cg_blog_archive_title_bg_img',
                        'type' => 'media',
                        'title' => __( 'Blog Archive Title Background Image', 'commercegurus' ),
                        'url' => true,
                    ),
                    array(
                        'desc' => __( 'Blog thumbnails', 'commercegurus' ),
                        'id' => 'cg_blog_images',
                        'type' => 'select',
                        'options' => array(
                            'default' => __( 'Default - above blog post', 'commercegurus' ),
                            'right' => __( 'Right Thumbnail', 'commercegurus' ),
                            'left' => __( 'Left Thumbnail', 'commercegurus' ),
                        ),
                    ...
                    array(
                        ...
                        'type' => 'select',
                        'options' => array(
                            'default' => __( 'Default - left sidebar', 'commercegurus' ),
                            'right' => __( 'Right sidebar', 'commercegurus' ),
                            'none' => __( 'No sidebar', 'commercegurus' ),
                        ),
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    array(
                        ...
                        'type' => 'select',
                        'options' => array(
                            'enabled' => __( 'Enable', 'commercegurus' ),
                            'disabled' => __( 'Disable', 'commercegurus' ),
                        ),
                        'default' => 'disabled',
                    ),
                    array(
                    ...
                    array(
                        'desc' => __( 'Upload an optional background image for your shop page title. The image should be at least 1200px wide for best results.', 'commercegurus' ),
                        'id' => 'cg_shop_archive_title_bg_img',
                        'type' => 'media',
                        'title' => __( 'Shop Page Title Background Image', 'commercegurus' ),
                        'url' => true,
                    ),
                    array(
                        ...
                        'options' => array(
                            'show' => __( 'Show', 'commercegurus' ),
                            'hide' => __( 'Hide', 'commercegurus' ),
                        ),
                        'default' => 'show'
                    ),
                    array(
                        ...
                        'mode' => 'checkbox',
                        'options' => array(
                            '1' => __( 'Visa', 'commercegurus' ),
                            '2' => __( 'Mastercard', 'commercegurus' ),
                            '3' => __( 'Paypal', 'commercegurus' ),
                            '4' => __( 'Amex', 'commercegurus' ),
                        ),
                        'default' => array(
                            '1' => true,
                            '2' => true,
                    ...
                    array(
                        ...
                        'type' => 'color',
                        'title' => __( 'Sale label background color', 'commercegurus' ),
                        'subtitle' => __( 'Select the color for your Sale label background color.', 'commercegurus' ),
                        'default' => '#42983B',
                    ),   
                ),
            );
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'type' => 'select',
                        'options' => array(
                            'wc_product_no_sidebar' => __( 'None', 'commercegurus' ),
                            'wc_product_left_sidebar' => __( 'Sidebar on the left', 'commercegurus' ),
                            'wc_product_right_sidebar' => __( 'Sidebar on the right', 'commercegurus' ),
                        ),
                        'title' => __( 'Product Sidebar Position', 'commercegurus' ),
                        'default' => 'no_sidebar',
                    ),           
                    array(
                        'id' => 'wc_product_banner_img',
                        'type' => 'select',
                        'options' => array(
                            'yes' => __( 'Yes', 'commercegurus' ),
                            'no' => __( 'No', 'commercegurus' ),
                        ),
                        'title' => __( 'Display the featured product image in the page banner?', 'commercegurus' ),
                        'default' => 'yes',
                    ),
                    array(
                        'id' => 'wc_product_sku',
                    ...
                    array(
                        ...
                        'default' => __( 'Delivery and Returns Information', 'commercegurus' ),
                    ),
                    array(
                        ...
                        'default' => __( 'Delivery and Returns Content description.', 'commercegurus' ),
                    ),                 
                ),
            );
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    array(
                        ...
                        'options' => array(
                            'none' => __( 'No sidebar', 'commercegurus' ),
                            'left-sidebar' => __( 'Sidebar on the left', 'commercegurus' ),
                            'right-sidebar' => __( 'Sidebar on the right', 'commercegurus' ),
                        ),
                    ...
                    array(
                        ...
                        'type' => 'select',
                        'options' => array(
                            'grid-layout' => __( 'Grid Layout', 'commercegurus' ),
                            'list-layout' => __( 'List Layout', 'commercegurus' ),
                        ),
